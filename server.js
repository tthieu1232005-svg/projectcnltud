...
const { getHomePage, searchBranches, detailPage } = require('./controllers/customerController');// Thêm vào để render trang chủ và tìm kiếm
...
});*/ // Bỏ đi vì đã có controller getHomePage xử lý rồi, tránh trùng lặp render trang chủ
...
app.get('/', getHomePage); // Cái mới

app.get('/search', searchBranches); // Cái mới
