...
// Hiển thị trang hồ sơ: URL dạng /host/65a123bc.../profile
router.get('/:hostId/profile', hostController.getHostProfile);

// Xử lý cập nhật hồ sơ: URL dạng /host/65a123bc.../profile
router.post('/:hostId/profile', hostController.updateHostProfile);
module.exports = router;