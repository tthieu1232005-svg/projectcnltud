...
const { getHostProfile, updateHostProfile, getHostBranches, getHostSpaces, getHostBookings, get } = require('../controllers/hostController');
...
router.get('/dashboard/:hostId', hostController.getDashboard);
