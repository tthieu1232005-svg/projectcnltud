...
async function getDashboard(req, res) {
  try {
    ...
    // 1. LẤY THÔNG TIN PROFILE HOST (Thêm fallback object rỗng tránh lỗi crash giao diện)
    ...
    // DOANH THU (Đã ép kiểu ObjectId để Aggregate chạy chính xác 100%)
    const spaceObjectIds = spaceIds.map(id => new mongoose.Types.ObjectId(id));
