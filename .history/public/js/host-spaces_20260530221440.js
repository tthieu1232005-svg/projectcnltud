...
// ID mẫu dùng kiểm tra dữ liệu từ MongoDB Compass (Thay bằng ID thực của bạn)
...
async function initHostDashboard(hostId) {
    try {
        ...
        if (floorPlanContainer) {
            floorPlanContainer.innerHTML = ""; // Xóa sạch các ô mẫu cũ
        ...
        if (recentTableBody) {
            recentTableBody.innerHTML = ""; // Xóa trống dòng mẫu cũ
