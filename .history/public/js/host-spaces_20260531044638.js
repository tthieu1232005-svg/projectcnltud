...
async function loadProfile() {
    try {
        ...
        console.log("Dữ liệu profile tải về:", data); // Check log xem có data chưa nhé

        // HIỂN THỊ THÔNG TIN USER LOGIN
        document.getElementById('host-name').innerText = data.user?.FullName || 'Chưa cập nhật';
        document.getElementById('host-id').innerText = data.user?._id || '';
